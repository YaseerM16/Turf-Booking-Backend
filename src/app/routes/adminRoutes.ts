...
router.get("/get-approved-companies", (req: Request, res: Response) => adminController.getApprovedCompany(req, res))
router.get("/company-toggle-block", (req: Request, res: Response) => adminController.companyToggleBlock(req, res))
